...
class ExampleReflex < ApplicationReflex
  ...
  def change
    # method 1
    # morph "#foo", "Changed All. Yes, you are currently Ruby on Rails, but soon you'll be Elixir dranken Phoenix"
    ...
    # method 3
    replacementElement = "<div id=\"foo\"><b>ICE CREAM</b></div>"
    morph "#foo", replacementElement
  end
