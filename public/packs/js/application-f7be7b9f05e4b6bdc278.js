...
var map = {
	...
	"./pagy_controller.js": "./app/javascript/controllers/pagy_controller.js"
};
...
/* This is the custom StimulusReflex controller for the Pagy Reflex.
 * Learn more at: https://docs.stimulusreflex.com
 */
...
var _default = /*#__PURE__*/function (_ApplicationControlle) {
  ...
  _createClass(_default, [{
    ...
    */
     ...
     *
     * Important:
     * Make sure to add data-controller="pagy" to your markup alongside
     * data-reflex="Pagy#dance" for the lifecycle methods to fire properly.
     *
     * Example:
     *
     *   <a href="#" data-reflex="click->Pagy#dance" data-controller="pagy">Dance!</a>
     *
     * Arguments:
     *
     *   element - the element that triggered the reflex
     *             may be different than the Stimulus controller's this.element
     *
     *   reflex - the name of the reflex e.g. "Pagy#dance"
     *
     *   error/noop - the error message (for reflexError), otherwise null
     *
     *   reflexId - a UUID4 or developer-provided unique identifier for each Reflex
     */
    // Assuming you create a "Pagy#dance" action in your Reflex class
    // you'll be able to use the following lifecycle methods:
    // beforeDance(element, reflex, noop, reflexId) {
    //  element.innerText = 'Putting dance shoes on...'
    // }
...
/******/ });
//# sourceMappingURL=application-f7be7b9f05e4b6bdc278.js.map